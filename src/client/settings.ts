...
export const TAB_ID = 'dsh-sidebar-vscode:vscode'
 ...
 */
export function readSetting(store: StoreLike | undefined, key: string): string {
 ...
 */
export function readSettingValue(store: StoreLike | undefined, key: string): unknown {
