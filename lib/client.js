...
`;
		...
		*/
		function VscodeView(props) {
			...
			const ready = (cwd !== void 0 || cwdFailed) && !resolvingBase;
...
`;
		...
		*/
		function readComposerPoint(client, sessionId) {
			...
			return composerDisplayedFor(client.sessions, sessionId) ? readActiveComposerSelection() : void 0;
		}
		...
		function apply(ctx) {
			...
			const lander = (sessionId, payload, options, at) => {
				return (async () => {
					...
					const point = at !== void 0 ? at : ownPoint ? readComposerPoint(client, sessionId) : void 0;
					...
					if (ownPoint && point !== void 0 && outcome.caret !== void 0 && client.conversation?.input.keyboard === void 0) restoreActiveComposerCaret(outcome.caret);
					return outcome;
				})();
			};
			...
			const removeRef = (sessionId, ref) => {
				removeVscodeReferences(client.sessions, client.conversation, sessionId, ref);
			};
			client.effect(() => {
