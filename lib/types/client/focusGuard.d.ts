...
export declare const BOOT_WINDOW_MS = 6000;
/** A parent Tab keypress this recent counts as a focus handoff (ms). */
export declare const PARENT_TAB_WINDOW_MS = 250;
/**
 ...
 */
export declare function fenceShouldBounce(facts: FenceFacts, now: number): boolean;
